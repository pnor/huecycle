...
(defvar colorize--default-start-color "#888888"
  "Default color to start from if a face is unspecified")
...
;; TODO change specs from list to single
(defun colorize--init-interp-datum (face specs &rest rest)
  (assert (facep face) "FACE isn't a valid face")
  (let (
...
(defun colorize--get-start-color (interp-datum)
  ...
  (let* (
         ...
         (spec (colorize--interp-datum-specs interp-datum))
         (attribute (face-attribute face :background))
